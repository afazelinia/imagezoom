...
var Props = /** @class */ (function () {
    function Props() {
        ...
        this.renderIndicator = function (currentIndex, allSize) {
            return React.createElement(View, { style: image_viewer_style_1.simpleStyle.count }, React.createElement(Text, { style: image_viewer_style_1.simpleStyle.countText }, currentIndex + '/' + allSize));
        };
        /**
